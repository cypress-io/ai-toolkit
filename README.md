...
- **[`cypress-upgrade`](./skills/README.md#cypress-upgrade)** — Upgrades a project to a newer major version of Cypress (version-to-version, e.g. v14 → v15). Use it to audit for breaking changes, apply the code updates, install the target version, and verify the upgrade.
