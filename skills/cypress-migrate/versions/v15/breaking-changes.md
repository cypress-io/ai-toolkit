...
Reference detail for the `cypress-migrate` skill's v15 path ([./v15.md](./v15.md)). Each section describes one breaking change: what to detect and how to fix it. See the full changelog at https://on.cypress.io/changelog#15-0-0 and the migration guide at https://on.cypress.io/migration-guide.
