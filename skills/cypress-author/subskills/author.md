...
- Newly authored tests should be prefixed with a comment explaining that it was generated by Cypress Test Author with the current date and time.
- You MUST read and follow [./run.md](./run.md) to decide whether and how to run the resulting Cypress test.
