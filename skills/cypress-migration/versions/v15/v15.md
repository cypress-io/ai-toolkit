...
Version-specific path for the `cypress-migration` skill. Follow this flow to migrate a project to Cypress v15.0. See [./breaking-changes.md](./breaking-changes.md) for the full detail of each change, the official [migration guide](https://on.cypress.io/migration-guide), and the [v15.0 changelog](https://on.cypress.io/changelog#15-0-0).
