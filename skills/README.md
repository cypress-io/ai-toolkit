...
Upgrade paths live under [`./cypress-upgrade/versions/`](./cypress-upgrade/versions); **v13, v14, and v15** are the paths available today, and more major versions will be added over time.
