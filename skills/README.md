...
npx skills add https://github.com/cypress-io/ai-toolkit --skill cypress-migration
```
...
gh skill install cypress-io/ai-toolkit cypress-migration
```
...
### [`cypress-migration`](./cypress-migration)
...
Migration paths live under [`./cypress-migration/versions/`](./cypress-migration/versions); **v15** is the path available today, and more major versions will be added over time.
...
```skill
/cypress-migration Upgrade this project to Cypress v15 and tell me what I need to change.
```
